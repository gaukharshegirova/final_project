...
DATABASES = {
    'default': {
        ...
        'PASSWORD': config('Tech12345'),
        'HOST': 'awsproject-rds.c9sma6sugime.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awsprojectasyablog' # please enter your s3 bucket name
