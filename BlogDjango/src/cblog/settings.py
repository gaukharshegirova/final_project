...
DATABASES = {
    'default': {
        ...
        'PASSWORD': config('data12345'),
        'HOST': 'projectdb.c9sma6sugime.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'project-web-site' # please enter your s3 bucket name
